...
namespace WebMagazine.Controllers
{
    ...
    {
        private readonly WebMagazineDbContext _context;

        public ProductController(WebMagazineDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'WebMagazineDbContext.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebMagazineDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
